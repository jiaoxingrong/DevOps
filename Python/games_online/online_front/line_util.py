...
class online(object):
    def __init__(self):
        metadata = MetaData()
        self.engine = create_engine('mysql://root:123456@localhost:3006/games_online', encoding='utf-8',pool_recycle=7200,pool_size=15,max_overflow=30)
    ...
    def alert(self, gamecode, language, region, server_id, alert_per, now_online, his_online, alert_value, dbconn):
        ...
        mail_to = 'qinjiaoxingrong@163.com'
